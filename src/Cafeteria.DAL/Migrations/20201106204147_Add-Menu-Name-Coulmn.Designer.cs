...
namespace Cafeteria.DAL.Migrations
{
    ...
    [Migration("20201106204147_Add-Menu-Name-Coulmn")]
    partial class AddMenuNameCoulmn
    {
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            MenuDate = new DateTime(2020, 11, 7, 22, 41, 45, 856, DateTimeKind.Local).AddTicks(8286),
                            Name = "Some name"
                        },
                        new
                        {
                            Id = 2,
                            MenuDate = new DateTime(2020, 11, 8, 22, 41, 45, 856, DateTimeKind.Local).AddTicks(9516),
                            Name = "Some name"
                        });
                });
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 11, 6, 22, 41, 45, 865, DateTimeKind.Local).AddTicks(4901),
                            IsTakeAway = false,
                            OrderStatus = 0,
                            PaymentType = 0,
                            TotalSum = 105.5m,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2020, 11, 6, 22, 41, 45, 866, DateTimeKind.Local).AddTicks(323),
                            IsTakeAway = true,
                            OrderStatus = 0,
                            PaymentType = 2,
                            TotalSum = 155.5m,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2020, 11, 6, 22, 41, 45, 866, DateTimeKind.Local).AddTicks(463),
                            IsTakeAway = true,
                            OrderStatus = 0,
                            PaymentType = 1,
                            TotalSum = 155.5m,
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FinalDate = new DateTime(2020, 11, 8, 22, 41, 45, 849, DateTimeKind.Local).AddTicks(9387),
                            Name = "Borscht",
                            Price = 30.0m,
                            ProductCategory = 3,
                            Weight = 300.0
                        ...
                        new
                        {
                            Id = 2,
                            Description = "bla bla bla",
                            FinalDate = new DateTime(2020, 11, 11, 22, 41, 45, 856, DateTimeKind.Local).AddTicks(4053),
                            Name = "Varenyky",
                            Price = 25.0m,
                            ProductCategory = 3,
                            Weight = 200.0
