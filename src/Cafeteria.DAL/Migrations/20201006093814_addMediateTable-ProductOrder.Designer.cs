...
namespace Cafeteria.DAL.Migrations
{
    ...
    [Migration("20201006093814_addMediateTable-ProductOrder")]
    partial class addMediateTableProductOrder
    {
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            MenuDate = new DateTime(2020, 10, 7, 12, 38, 13, 545, DateTimeKind.Local).AddTicks(7188)
                        },
                        new
                        {
                            Id = 2,
                            MenuDate = new DateTime(2020, 10, 8, 12, 38, 13, 545, DateTimeKind.Local).AddTicks(7931)
                        });
                });
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 10, 6, 12, 38, 13, 550, DateTimeKind.Local).AddTicks(4058),
                            IsTakeAway = false,
                            OrderStatus = 0,
                            PaymentType = 0,
                            TotalSum = 105.5m,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2020, 10, 6, 12, 38, 13, 550, DateTimeKind.Local).AddTicks(6840),
                            IsTakeAway = true,
                            OrderStatus = 0,
                            PaymentType = 1,
                            TotalSum = 155.5m,
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FinalDate = new DateTime(2020, 10, 8, 12, 38, 13, 540, DateTimeKind.Local).AddTicks(7224),
                            Name = "Borscht",
                            Price = 30.0m,
                            ProductCategory = 3,
                            Weight = 300.0
                        ...
                        new
                        {
                            Id = 2,
                            Description = "bla bla bla",
                            FinalDate = new DateTime(2020, 10, 11, 12, 38, 13, 545, DateTimeKind.Local).AddTicks(5544),
                            Name = "Varenyky",
                            Price = 25.0m,
                            ProductCategory = 3,
                            Weight = 200.0
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.UserProfile", b =>
                {
                    b.HasOne("Сafeteria.DataModels.Entities.User", "User")
                        .WithOne("Profile")
                        .HasForeignKey("Сafeteria.DataModels.Entities.UserProfile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
