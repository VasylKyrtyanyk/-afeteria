...
namespace Cafeteria.DAL.Migrations
{
    ...
    [Migration("20201006104652_dataSeedUpdate")]
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            MenuDate = new DateTime(2020, 10, 7, 13, 46, 51, 985, DateTimeKind.Local).AddTicks(2200)
                        },
                        new
                        {
                            Id = 2,
                            MenuDate = new DateTime(2020, 10, 8, 13, 46, 51, 985, DateTimeKind.Local).AddTicks(2704)
                        });
                });
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 10, 6, 13, 46, 51, 989, DateTimeKind.Local).AddTicks(2552),
                            IsTakeAway = false,
                            OrderStatus = 0,
                            PaymentType = 0,
                            TotalSum = 105.5m,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2020, 10, 6, 13, 46, 51, 989, DateTimeKind.Local).AddTicks(5140),
                            IsTakeAway = true,
                            OrderStatus = 0,
                            PaymentType = 2,
                            TotalSum = 155.5m,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2020, 10, 6, 13, 46, 51, 989, DateTimeKind.Local).AddTicks(5253),
                            IsTakeAway = true,
                            OrderStatus = 0,
                            PaymentType = 1,
                            TotalSum = 155.5m,
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FinalDate = new DateTime(2020, 10, 8, 13, 46, 51, 982, DateTimeKind.Local).AddTicks(3346),
                            Name = "Borscht",
                            Price = 30.0m,
                            ProductCategory = 3,
                            Weight = 300.0
                        ...
                        new
                        {
                            Id = 2,
                            Description = "bla bla bla",
                            FinalDate = new DateTime(2020, 10, 11, 13, 46, 51, 985, DateTimeKind.Local).AddTicks(1191),
                            Name = "Varenyky",
                            Price = 25.0m,
                            ProductCategory = 3,
                            Weight = 200.0
