...
namespace Cafeteria.DAL.Migrations
{
    ...
    [Migration("20201214103346_addImageNameFieldToProduct")]
    partial class addImageNameFieldToProduct
    {
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            MenuDate = new DateTime(2020, 12, 15, 12, 33, 45, 401, DateTimeKind.Local).AddTicks(4740),
                            Name = "Some name"
                        },
                        new
                        {
                            Id = 2,
                            MenuDate = new DateTime(2020, 12, 16, 12, 33, 45, 401, DateTimeKind.Local).AddTicks(5423),
                            Name = "Some name"
                        });
                });
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 12, 14, 12, 33, 45, 407, DateTimeKind.Local).AddTicks(76),
                            IsTakeAway = false,
                            OrderStatus = 0,
                            PaymentType = 0,
                            TotalSum = 105.5m,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2020, 12, 14, 12, 33, 45, 407, DateTimeKind.Local).AddTicks(3657),
                            IsTakeAway = true,
                            OrderStatus = 0,
                            PaymentType = 2,
                            TotalSum = 155.5m,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2020, 12, 14, 12, 33, 45, 407, DateTimeKind.Local).AddTicks(3760),
                            IsTakeAway = true,
                            OrderStatus = 0,
                            PaymentType = 1,
                            TotalSum = 155.5m,
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FinalDate = new DateTime(2020, 12, 16, 12, 33, 45, 395, DateTimeKind.Local).AddTicks(2195),
                            Name = "Borscht",
                            Price = 30.0m,
                            ProductCategory = 3,
                            Weight = 300.0
                        ...
                        new
                        {
                            Id = 2,
                            Description = "bla bla bla",
                            FinalDate = new DateTime(2020, 12, 19, 12, 33, 45, 401, DateTimeKind.Local).AddTicks(2640),
                            Name = "Varenyky",
                            Price = 25.0m,
                            ProductCategory = 3,
                            Weight = 200.0
