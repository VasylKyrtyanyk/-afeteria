...
namespace Cafeteria.DAL.Migrations
{
    ...
    [Migration("20201016163715_AddedTokenField")]
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Menu", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            MenuDate = new DateTime(2020, 10, 17, 19, 37, 14, 545, DateTimeKind.Local).AddTicks(7962)
                        },
                        new
                        {
                            Id = 2,
                            MenuDate = new DateTime(2020, 10, 18, 19, 37, 14, 545, DateTimeKind.Local).AddTicks(8456)
                        });
                });
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2020, 10, 16, 19, 37, 14, 549, DateTimeKind.Local).AddTicks(3935),
                            IsTakeAway = false,
                            OrderStatus = 0,
                            PaymentType = 0,
                            TotalSum = 105.5m,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2020, 10, 16, 19, 37, 14, 549, DateTimeKind.Local).AddTicks(6470),
                            IsTakeAway = true,
                            OrderStatus = 0,
                            PaymentType = 2,
                            TotalSum = 155.5m,
                        ...
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2020, 10, 16, 19, 37, 14, 549, DateTimeKind.Local).AddTicks(6546),
                            IsTakeAway = true,
                            OrderStatus = 0,
                            PaymentType = 1,
                            TotalSum = 155.5m,
            ...
            modelBuilder.Entity("Сafeteria.DataModels.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FinalDate = new DateTime(2020, 10, 18, 19, 37, 14, 543, DateTimeKind.Local).AddTicks(5190),
                            Name = "Borscht",
                            Price = 30.0m,
                            ProductCategory = 3,
                            Weight = 300.0
                        ...
                        new
                        {
                            Id = 2,
                            Description = "bla bla bla",
                            FinalDate = new DateTime(2020, 10, 21, 19, 37, 14, 545, DateTimeKind.Local).AddTicks(6981),
                            Name = "Varenyky",
                            Price = 25.0m,
                            ProductCategory = 3,
                            Weight = 200.0
